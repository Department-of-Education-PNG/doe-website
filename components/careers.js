window.CareersComponent = {
    render: async () => {
        return `
            <div style="height: 300px; display:flex; align-items:center; justify-content:center; background: linear-gradient(135deg, rgba(160, 32, 240, 0.2), transparent); border-bottom: 1px solid var(--glass-border);">
                <div>
