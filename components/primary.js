window.PrimaryComponent = {
    render: async () => {
        return `
            <div class="subpage-header" style="background: linear-gradient(135deg, rgba(20, 50, 95, 0.95) 0%, rgba(14, 32, 64, 0.8) 100%), url('assets/images/hero/hero-2.jpg') center/cover; padding: 10rem 2rem 6rem; text-align: center; position: relative; overflow: hidden;">
