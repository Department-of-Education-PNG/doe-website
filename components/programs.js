window.ProgramsComponent = {
    render: async () => {
        return `
            <div style="min-height: 300px; padding: 8rem 2rem 4rem; display:flex; flex-direction:column; align-items:center; justify-content:center; background: linear-gradient(135deg, rgba(0, 112, 243, 0.6), rgba(10, 13, 20, 0.8), rgba(245, 166, 35, 0.3)), url('assets/images/other-tabs-header-banner/banner-bg.png') center/cover no-repeat; border-bottom: 1px solid var(--glass-border);">
                <div>
            ...
            <section class="section-full" style="padding: var(--section-spacing) 0;">
                <div class="grid-3">
                    <div class="card glass-panel" style="text-align: center; padding: var(--card-padding);">
                        <div style="font-size: 3rem; margin-bottom: 1rem;">🎯</div>
                        <h3>Activities</h3>
                        <p style="color: var(--text-muted);">Latest programmatic updates and ongoing educational activities across the nation.</p>
                        <a href="#news" class="btn-primary" style="margin-top: 1.5rem; display: inline-block;">View Activities</a>
                    </div>
                    <div class="card glass-panel" style="text-align: center; padding: var(--card-padding);">
                        <div style="font-size: 3rem; margin-bottom: 1rem;">💻</div>
                        ...
                        <a href="#app-gallery" class="btn-primary" style="margin-top: 1.5rem; display: inline-block;">Access Digital Portal</a>
                    </div>
                    <div class="card glass-panel" style="text-align: center; padding: 3rem 2rem;">
                        ...
                        <a href="#publications" class="btn-primary" style="margin-top: 1.5rem; display: inline-block;">Download Papers</a>
                    </div>
                </div>
            </section>
        `;
